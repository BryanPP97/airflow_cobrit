...
#import scrapers
from utils.sms import gepard_automation, email, process_sms, marcatel_automation
...
with DAG(
    ...
    description="Sends email for positive sms",
    start_date= datetime(year=2023, month=9, day=18),
